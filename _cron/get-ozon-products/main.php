...
{%
    ...
    ozon_product_id = page.ozon_product_id
    ozon_product_offer_id = page.ozon_product_offer_id
    ozon_product_name = page.ozon_product_name
    ozon_product_barcodes = page.ozon_product_barcodes
    ozon_product_created_at = page.ozon_product_created_at
    ozon_product_updated_at = page.ozon_product_updated_at
    ozon_product_vat = page.ozon_product_vat
    ozon_product_color_image = page.ozon_product_color_image
    ozon_product_primary_image = page.ozon_product_primary_image
    ozon_product_images = page.ozon_product_images
    ozon_product_all_images = page.ozon_product_all_images
    ozon_product_sku = page.ozon_product_sku
    ozon_product_package_x = page.ozon_product_package_x
